...
(function () {
  ...
  var getAdObj = function (i) {
    return {
      ...
      offer: {
        title: 'Заголовок',
        address: window.util.getRandomNumber(0, window.map.MAP_SIZES.width) + ', ' + window.util.getRandomNumber(130, 630),
      ...
      location: {
        x: window.util.getRandomNumber(0, window.map.MAP_SIZES.width),
